...
document.getElementById("Korea").addEventListener("click", () => {
  section.innerHTML = "";
  createMenuItems(menu.filter((item) => item.category === "Korea"));
});

document.getElementById("Japan").addEventListener("click", () => {
  section.innerHTML = "";
  createMenuItems(menu.filter((item) => item.category === "Japan"));
});

document.getElementById("China").addEventListener("click", () => {
  section.innerHTML = "";
  createMenuItems(menu.filter((item) => item.category === "China"));
});
